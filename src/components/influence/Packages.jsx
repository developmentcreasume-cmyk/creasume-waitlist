  ...
  return (
    <section className="relative z-10 px-8 sm:px-12 md:px-20 lg:px-28 pt-32 md:pt-52 pb-12 md:pb-20 overflow-hidden">
      ...
      <img
        ...
        alt=""
        draggable={false}
        style={{ position: 'absolute', left: 110, top: 10, width: 680, height: 680, objectFit: 'contain', opacity: flying ? 0 : 0.9, transform: 'rotate(8deg)', pointerEvents: 'none', filter: 'drop-shadow(0 12px 30px rgba(0,0,0,0.5))', zIndex: -1 }}
      />
